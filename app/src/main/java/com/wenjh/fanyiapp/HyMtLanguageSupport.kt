...
object HyMtLanguageSupport {
    ...
    val supportedLanguages: List<LanguageOption> = listOf(
        ...
        LanguageOption("yue", "Cantonese", "Cantonese", "粤语"),
        LanguageOption("zh", "Chinese", "Chinese", "中文"),
        ...
        LanguageOption("zh-Hant", "Traditional Chinese", "Traditional Chinese", "繁体中文"),
